...
<div class="navbar-wrapper container-wrapper snipcss-nGxBf">
  <nav class="container-fluid navbar">
    <div class="flex v-center FAQGyh">
      <a href="//seller.shopee.com.my" target="_blank" rel="noopener noreferrer" class="_2TLLZP ZUq1cc">
        Seller Centre
      </a>
      <div class="shopee-drawer ZUq1cc" id="pc-drawer-id-0">
        <a class="_2TLLZP" href="/web/" target="_blank" rel="noopener noreferrer" id="temporaryId">
          Download
        </a>
      </div>
      <div class="flex _2TLLZP ZUq1cc HniJJe">
        Follow us on
      </div>
      <div class="flex _2TLLZP FK3705">
        <a class="D7dyDc header-navbar-background header-navbar-facebook-png" href="https://facebook.com/ShopeeMY" target="_blank" rel="noopener noreferrer" title="Follow us on Facebook">
        </a>
        <a href="https://instagram.com/Shopee_MY" target="_blank" rel="noopener noreferrer" class="VR+xYc header-navbar-background header-navbar-instagram-png" title="Follow us on Instagram!">
        </a>
      </div>
    </div>
    ...
    <ul class="navbar__links">
      <li class="navbar__link--notification navbar__link navbar__link--hoverable navbar__link--tappable">
        <div class="stardust-popover" id="stardust-popover2" tabindex="0">
          <div role="button" class="stardust-popover__target">
            <a class="W-2aSq" tabindex="-1" href="/user/notifications/order">
      ...
      <a class="navbar__link navbar__link--tappable navbar__link--hoverable navbar__link--help" href="https://help.shopee.com.my/my/s" target="_blank" rel="noopener noreferrer" tabindex="0">
        ...
        <span class="navbar__link-text navbar__link--tappable navbar__link--hoverable">
          help
        </span>
      </a>
      <li class="navbar__link--notification navbar__link navbar__link--hoverable navbar__link--tappable">
            ...
            <div class="n1sJN5">
              <div class="UkG+ar">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M8.00065 14.6667C11.6825 14.6667 14.6673 11.6819 14.6673 8.00004C14.6673 4.31814 11.6825 1.33337 8.00065 1.33337C4.31875 1.33337 1.33398 4.31814 1.33398 8.00004C1.33398 11.6819 4.31875 14.6667 8.00065 14.6667Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
                  </path>
                  <path d="M5.33464 8.00004C5.33464 11.6819 6.52854 14.6667 8.0013 14.6667C9.47406 14.6667 10.668 11.6819 10.668 8.00004C10.668 4.31814 9.47406 1.33337 8.0013 1.33337C6.52854 1.33337 5.33464 4.31814 5.33464 8.00004Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
                  </path>
          ...
          <div role="button" class="stardust-popover__target">
            <div class="navbar__link--account__container">
              <div class="shopee-avatar">
                ...
                <img class="shopee-avatar__img" src="https://down-my.img.susercontent.com/file/b82f97590f0f48244a4de6b378e4aa7e_tn">
              </div>
